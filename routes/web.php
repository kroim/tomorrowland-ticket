...
Route::post('/tomorrowland/order', 'HomeController@order');
Route::post('/tomorrowland/payment', 'HomeController@payment');
Route::get('/tomorrowland/payment', 'HomeController@paymentPage');
Route::post('/tomorrowland/payment/pre_order', 'HomeController@pre_order');
//Route::post('/tomorrowland/payment_success', 'Main\DashboardController@payment_success');
Route::get('/tomorrowland/payment_success', 'HomeController@payment_success');
Route::get('/tomorrowland/order/{id}', 'HomeController@successOrder');
