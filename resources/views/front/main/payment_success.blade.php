                ...
                @isset($order)
                    ...
                    <div class="overview" style="margin: 2% 5%;padding: 5% 5%;background: lightgreen;border-radius: 10px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-xs-8"><p>{{$order->user_name}}</p></div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 col-xs-4"><p>@lang('global.account.email')</p></div>
                            <div class="col-md-8 col-xs-8"><p>{{$order->user_email}}</p></div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 col-xs-4"><p>@lang('global.account.phone')</p></div>
                            <div class="col-md-8 col-xs-8"><p>{{$order->user_phone}}</p></div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 col-xs-4"><p>@lang('global.account.address')</p></div>
                            <div class="col-md-8 col-xs-8"><p>{{$order->user_address}}</p></div>
                        </div>
                    </div>
                @endisset
            </div>
