    ...
    <div class="container">
        ...
        <div class="left-side">
            ...
            <nav id="navigation" class="style-1">
                <ul id="responsive">
                    ...
                    <li><a href="{{ url('/') }}">Oktorbofest</a></li>
                </ul>
            </nav>
        ...
        <div class="right-side">
            <div class="header-widget">
                ...
                @if(Auth::check())
                    <a href="{{ url('account/profile') }}" class="header-right"><i class="sl sl-icon-user"></i> My Account</a>
                @else
                    <a href="{{ url('login') }}" class="header-right"><i class="sl sl-icon-user"></i> Login</a>
                @endif
